...
public class TelaEncerramento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Home2.addActionListener(evt -> Home2ActionPerformed(evt));
        ...
        Sair1.addActionListener(evt -> Sair1ActionPerformed(evt));
    ...
    public static void main(String[] args) {
        java.awt.EventQueue.invokeLater(() -> new TelaEncerramento().setVisible(true));
    }
